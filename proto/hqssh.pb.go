...
func (x *SystemInfo) GetCommit() string {
	if x != nil {
		return x.Commit
	}
	return ""
...
type SystemStatus struct {
	...
	Pid            int32                  `protobuf:"varint,4,opt,name=pid,proto3" json:"pid,omitempty"` // Daemon process id (0 from daemons older than v1.4.0)
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *SystemStatus) GetPid() int32 {
	if x != nil {
		return x.Pid
	}
	return 0
...
const file_proto_hqssh_proto_rawDesc = "" +
	...
	"\x0factive_projects\x18\x03 \x01(\x05R\x0eactiveProjects\x12\x10\n" +
	"\x03pid\x18\x04 \x01(\x05R\x03pid\"\xae\x01\n" +
	"\aProject\x12\x0e\n" +
